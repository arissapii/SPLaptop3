        ...
        <main>
          <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
              ...
              <!-- Button Tambah kerusakan -->
              <div class="mt-3 ms-3">
                <a class="btn btn-xl btn-outline-dark text-uppercase" data-bs-toggle="modal" data-bs-target="#exampleModal"> Tambah Data Kerusakan </a>
              </div>
              <!-- penutup button tambah kerusakan -->
                      ...
                      <div class="modal-body">
                        <form action="" method="post">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="kode" name="kode" placeholder="Kode kerusakan" value="" readonly>
                          </div>
              ...
              <!-- penutup modal tambah kerusakan -->

              <!-- modal ubah kerusakan -->
              
              <div class="modal fade ubahKerusakan" id="ubahKerusakan" tabindex="-1" role="dialog" aria-labelledby="forModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                        <label for="probabilitas">Nilai Probabilitas</label>
                        <input type="text" class="form-control" id="probabilitas" name="probabilitas" value="">
                      </div>
                      <div class="form-group">
                        <label for="gambar">Gambar Hardware</label>
                        <img style="margin-bottom: 10px; width: 100px;" src="">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#ubahKerusakan">Ubah</a>
                      </td>
                    </tr>
                  </tbody>
                </table>
